...
export default function ResourcesPage() {
  const downloads = [
    { title: "2024/2025 Academic Session Prospectus", desc: "Comprehensive course descriptions, department profiles, and fee schedules.", file: "UI_Consultancy_Prospectus_2024.pdf", size: "3.2 MB" },
