    ...
    <div className="bg-ui-gold-500/10 border-y border-ui-gold-500/30 py-2 px-4 text-xs font-medium text-ui-navy-950 font-sans">
      <div className="max-w-7xl mx-auto flex items-center justify-between gap-4 overflow-hidden">
        ...
        <div className="truncate text-slate-700">
          <span className="font-semibold text-ui-navy-900">2026/2027 Academic Session:</span> First batch admission list for Executive Diploma (Computer Science, Business Admin, HSE) released. Deadline for acceptance fee payment is Nov 30, 2026.
        </div>
        <Link
          href="/admissions"
